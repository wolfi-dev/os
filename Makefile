...
$(eval $(call build-package,py3-docutils,0.19-r4))
...
$(eval $(call build-package,nodejs-16,16.16.0-r2))
$(eval $(call build-package,nodejs-18,18.14.0-r2))
$(eval $(call build-package,nodejs-19,19.6.0-r2))
...
$(eval $(call build-package,vim,9.0.1275-r1))
