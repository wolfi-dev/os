...
$(eval $(call build-package,python-3.11,3.11.1-r4))
$(eval $(call build-package,glibc,2.36-r7))
...
$(eval $(call build-package,deno,1.29.1-r3))
...
$(eval $(call build-package,python3.10,3.10.9-r0))
...
$(eval $(call build-package,py3-appdirs,1.4.4-r4))
$(eval $(call build-package,py3-ordered-set,4.0.2-r4))
$(eval $(call build-package,py3-installer,0.5.1-r4))
$(eval $(call build-package,py3-tomli,2.0.1-r3))
$(eval $(call build-package,py3-gpep517,13-r4))
$(eval $(call build-package,py3-flit-core,3.8.0-r4))
$(eval $(call build-package,py3-parsing,3.0.9-r4))
$(eval $(call build-package,py3-packaging,21.3-r4))
$(eval $(call build-package,py3-more-itertools,9.0.0-r4))
$(eval $(call build-package,py3-setuptools-stage0,52.0.0-r3))
$(eval $(call build-package,py3-setuptools,59.4.0-r4))
$(eval $(call build-package,py3-pep517,0.13.0-r3))
$(eval $(call build-package,py3-six,1.16.0-r4))
$(eval $(call build-package,py3-retrying,1.3.4-r3))
$(eval $(call build-package,py3-contextlib2,21.6.0-r3))
$(eval $(call build-package,py3-pip,22.3.1-r3))
$(eval $(call build-package,py3-docutils,0.19-r5))
$(eval $(call build-package,py3-pygments,2.14.0-r3))
$(eval $(call build-package,py3-magic,0.4.27-r3))
$(eval $(call build-package,libedit,3.1-r2))
$(eval $(call build-package,tiff,4.5.0-r3))
...
$(eval $(call build-package,go-1.20,1.20.0-r1))
...
$(eval $(call build-package,trivy,0.37.1-r0))
...
$(eval $(call build-package,meson,1.0.0-r3))
$(eval $(call build-package,wasi-libc,0.20220525-r2))
$(eval $(call build-package,rust,1.67.0-r1))
$(eval $(call build-package,rustup,1.25.1-r1))
...
$(eval $(call build-package,libxml2,2.10.3-r4))
...
$(eval $(call build-package,xcb-proto,1.15.2-r3))
$(eval $(call build-package,libxcb,1.15-r3))
...
$(eval $(call build-package,py3-markupsafe,2.1.2-r3))
$(eval $(call build-package,py3-jinja2,3.1.2-r3))
$(eval $(call build-package,nodejs-16,16.16.0-r1))
$(eval $(call build-package,nodejs-18,18.14.0-r2))
$(eval $(call build-package,nodejs-19,19.6.0-r1))
$(eval $(call build-package,yarn,1.22.19-r3))
$(eval $(call build-package,libxt,1.2.1-r2))
$(eval $(call build-package,libusb,1.0.26-r2))
$(eval $(call build-package,libevent,2.1.12-r3))
...
$(eval $(call build-package,fontconfig,2.14.2-r1))
$(eval $(call build-package,giflib,5.2.1-r2))
$(eval $(call build-package,libjpeg,2.1.5-r0))
...
$(eval $(call build-package,llvm15,15.0.6-r2))
...
$(eval $(call build-package,bazel-5,5.4.0-r3,bazel))
$(eval $(call build-package,bazel-6,6.0.0-r4,bazel))
$(eval $(call build-package,libmaxminddb,1.7.1-r1))
$(eval $(call build-package,clang-15,15.0.6-r2))
...
$(eval $(call build-package,skopeo,1.11.0-r0))
...
$(eval $(call build-package,php,8.2.2-r0))
...
$(eval $(call build-package,kustomize,5.0.0-r0))
...
$(eval $(call build-package,flux,0.39.0-r0))
