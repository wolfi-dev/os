...
$(eval $(call build-package,openjdk-11,11.0.19.5-r2))
$(eval $(call build-package,openjdk-17,17.0.7.5-r2))
...
$(eval $(call build-package,maven,3.9.1-r2))
...
$(eval $(call build-package,gradle-stage0,8.0.1-r1))
$(eval $(call build-package,gradle-8,8.0.1-r1))
...
$(eval $(call build-package,sbt-stage0,1.8.2-r1))
$(eval $(call build-package,sbt,1.8.2-r1))
...
$(eval $(call build-package,zookeeper,3.8.1-r1))
