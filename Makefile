...
$(eval $(call build-package,strace,6.1-r0))
...
$(eval $(call build-package,ncurses,6.4-r0))
$(eval $(call build-package,pkgconf,1.9.4-r0))
$(eval $(call build-package,readline,8.2-r0))
$(eval $(call build-package,sqlite,3.40.1-r0))
$(eval $(call build-package,xz,5.4.1-r0))
...
$(eval $(call build-package,lua5.4,5.4.4-r0))
$(eval $(call build-package,apk-tools,2.12.11-r0))
...
$(eval $(call build-package,py3-six,1.16.0-r1))
...
$(eval $(call build-package,py3-pygments,2.14.0-r0))
$(eval $(call build-package,py3-magic,0.4.27-r0))
$(eval $(call build-package,libedit,3.1-r0))
$(eval $(call build-package,tiff,4.5.0-r0))
$(eval $(call build-package,pcre2,10.42-r0))
$(eval $(call build-package,git,2.39.1-r0))
$(eval $(call build-package,bash,5.2.15-r0))
$(eval $(call build-package,go-stage0,1.19.1-r0))
$(eval $(call build-package,go-1.18,1.18.9-r1))
$(eval $(call build-package,go-1.19,1.19.5-r1))
$(eval $(call build-package,go-1.20,1.20_rc1-r2))
$(eval $(call build-package,git-lfs,3.3.0-r0))
$(eval $(call build-package,openssh,9.0_p1-r0))
$(eval $(call build-package,skalibs,2.13.0.0-r0))
$(eval $(call build-package,execline,2.9.1.0-r0))
$(eval $(call build-package,s6,2.11.2.0-r0))
...
$(eval $(call build-package,http-parser,2.9.4-r0))
$(eval $(call build-package,libgit2,1.5.1-r0))
...
$(eval $(call build-package,libgcrypt,1.10.1-r1))
...
$(eval $(call build-package,docbook-xml,4.5-r0))
$(eval $(call build-package,xmlto,0.0.28-r1))
...
$(eval $(call build-package,libxtst,1.2.4-r1))
$(eval $(call build-package,rarian,0.8.1-r0))
...
$(eval $(call build-package,py3-markupsafe,2.1.2-r0))
$(eval $(call build-package,py3-jinja2,3.1.2-r0))
$(eval $(call build-package,nodejs,18.13.0-r0))
...
$(eval $(call build-package,openjdk-11,11.0.18-r0))
$(eval $(call build-package,openjdk-17,17.0.6-r0))
$(eval $(call build-package,su-exec,0.2-r0))
$(eval $(call build-package,llvm15,15.0.6-r0))
$(eval $(call build-package,postgresql-11,11.18-r0,postgresql))
$(eval $(call build-package,postgresql-12,12.13-r0,postgresql))
$(eval $(call build-package,postgresql-13,13.9-r0,postgresql))
$(eval $(call build-package,postgresql-14,14.6-r0,postgresql))
$(eval $(call build-package,postgresql-15,15.1-r0,postgresql))
...
$(eval $(call build-package,bazel-5,5.4.0-r1,bazel))
$(eval $(call build-package,bazel-6,6.0.0-r2,bazel))
...
$(eval $(call build-package,haproxy,2.6.7-r2))
...
$(eval $(call build-package,bind,9.18.10-r0))
