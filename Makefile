...
$(eval $(call build-package,ruby-concurrent-ruby,1.2.0-r0))
$(eval $(call build-package,ruby-http_parser.rb,0.8.0-r0))
$(eval $(call build-package,ruby-protocol-hpack,1.4.2-r0))
$(eval $(call build-package,ruby-yajl-ruby,-r0))
