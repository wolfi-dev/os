...
$(eval $(call build-package,glibc,2.37-r4))
$(eval $(call build-package,build-base,1-r5))
$(eval $(call build-package,gcc,12.2.0-r10))
...
$(eval $(call build-package,libxi,1.8-r3))
...
$(eval $(call build-package,postgresql-15,15.2-r1,postgresql))
...
$(eval $(call build-package,jenkins,2.395-r0))
...
$(eval $(call build-package,python-3.12,3.12.0_alpha6-r1))
