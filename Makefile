...
$(eval $(call build-package,etcd,3.5.7-r0))
...
$(eval $(call build-package,nghttp2,1.52.0-r0))
$(eval $(call build-package,curl,7.88.0-r0))
...
$(eval $(call build-package,git,2.39.2-r0))
...
$(eval $(call build-package,go-1.19,1.19.6-r0))
$(eval $(call build-package,go-1.20,1.20.1-r0))
$(eval $(call build-package,git-lfs,3.3.0-r3))
...
$(eval $(call build-package,trivy,0.37.2-r0))
...
$(eval $(call build-package,prometheus,2.42.0-r0))
...
$(eval $(call build-package,libjpeg,2.1.5.1-r0))
...
$(eval $(call build-package,kubectl,1.26.1-r0))
...
$(eval $(call build-package,haproxy,2.6.9-r0))
...
$(eval $(call build-package,rabbitmq-server,3.11.9-r0))
...
$(eval $(call build-package,eudev,3.2.11-r0extldflags))
