...
$(eval $(call build-package,busybox,1.35.0-r6))
...
$(eval $(call build-package,wolfi-baselayout,20221118-r2))
...
$(eval $(call build-package,c-ares,1.18.1-r2))
...
$(eval $(call build-package,grype,0.55.0-r2))
...
$(eval $(call build-package,rust,1.65.0-r3))
