...
$(eval $(call build-package,grype,0.59.0-r0))
$(eval $(call build-package,trivy,0.38.1-r0))
...
$(eval $(call build-package,flux,0.40.2-r0))
...
$(eval $(call build-package,libde265,1.0.11-r0))
