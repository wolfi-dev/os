...
$(eval $(call build-package,curl,7.88.0-r1))
...
$(eval $(call build-package,trivy,0.37.2-r1))
...
$(eval $(call build-package,nodejs-16,16.16.0-r0))
$(eval $(call build-package,nodejs-18,18.14.0-r1))
$(eval $(call build-package,nodejs-19,19.6.0-r0))
...
$(eval $(call build-package,libjpeg,2.1.5.1-r1))
...
$(eval $(call build-package,skopeo,1.11.0-r1))
...
$(eval $(call build-package,ruby-async-io,1.34.3-r0))
$(eval $(call build-package,ruby-cool.io,1.7.1-r0))
$(eval $(call build-package,ruby-fiber-local,1.0.0-r0))
$(eval $(call build-package,ruby-fluentd,1.15.3-r0))
$(eval $(call build-package,ruby-msgpack,1.6.0-r0))
$(eval $(call build-package,ruby-oj,3.14.2-r0))
$(eval $(call build-package,ruby-rexml,3.2.5-r0))
$(eval $(call build-package,ruby-serverengine,2.3.1-r0))
$(eval $(call build-package,ruby-sigdump,0.2.4-r0))
$(eval $(call build-package,ruby-strptime,0.2.5-r0))
$(eval $(call build-package,ruby-tzinfo-data,1.2022.7-r0))
$(eval $(call build-package,ruby-tzinfo,2.0.6-r0))
$(eval $(call build-package,ruby-webrick,1.8.1-r0))
...
$(eval $(call build-package,flux,0.39.0-r1))
